...
int main(int argc, char* argv[]) {
  ...
  char sigFolderName[1000];
  char bkgFolderName[1000];
  ...
  if ( argc < 3 ){
    ...
    cout << "Example:   ./DoTPrimeOptimization.x -sfile=signal.root -bfold=bkg_folder -ofile=output.root" << endl;
    cout << "Example:   ./DoTPrimeOptimization.x -sfold=sig_folder -bfold=bkg_folder -ofile=output.root -Njob=1 -ijob=0" << endl;
    return 1;
  }
  ...
  TPrimeOptimization Optimization;
