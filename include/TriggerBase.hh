...
// Fri Dec  8 13:22:31 2017 by ROOT version 5.34/25
// from TTree tree/TtHT
// found on file: DATA_2016.root
//////////////////////////////////////////////////////////
...
inline TriggerBase::TriggerBase(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DATA_2016.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DATA_2016.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("DATA_2016.root:/ana");
...
inline TriggerBase::~TriggerBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

inline Int_t TriggerBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
inline Long64_t TriggerBase::LoadTree(Long64_t entry)
{
...
inline void TriggerBase::Init(TTree *tree)
{
...
inline Bool_t TriggerBase::Notify()
{
...
inline void TriggerBase::Show(Long64_t entry)
{
...
inline Int_t TriggerBase::Cut(Long64_t entry)
{
